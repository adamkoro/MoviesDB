...
(person_id_seq.NEXTVAL, 'Christopher Nolan', TO_DATE('1970-07-30', 'YYYY-MM-DD'));
INSERT INTO directors (id, person_id) VALUES
(directors_id_seq.NEXTVAL, person_id_seq.CURRVAL);
INSERT INTO person (id, name, birth_date) VALUES
(person_id_seq.NEXTVAL, 'Leonardo DiCaprio', TO_DATE('1974-11-11', 'YYYY-MM-DD'));
INSERT INTO actors (id, person_id) VALUES
(actors_id_seq.NEXTVAL, person_id_seq.CURRVAL);
...
INSERT INTO person (id, name, birth_date) VALUES
(person_id_seq.NEXTVAL, 'Frank Darabont', TO_DATE('1959-01-28', 'YYYY-MM-DD'));
INSERT INTO directors (id, person_id) VALUES
(directors_id_seq.NEXTVAL, person_id_seq.CURRVAL);
INSERT INTO person (id, name, birth_date) VALUES
(person_id_seq.NEXTVAL, 'Morgan Freeman', TO_DATE('1937-06-01', 'YYYY-MM-DD'));
INSERT INTO actors (id, person_id) VALUES
(actors_id_seq.NEXTVAL, person_id_seq.CURRVAL);
INSERT INTO movies (id, title, release_year, genre_id, director_id) VALUES
...
INSERT INTO person (id, name, birth_date) VALUES
(person_id_seq.NEXTVAL, 'Quentin Tarantino', TO_DATE('1963-03-27', 'YYYY-MM-DD'));
INSERT INTO directors (id, person_id) VALUES
(directors_id_seq.NEXTVAL, person_id_seq.CURRVAL);
INSERT INTO person (id, name, birth_date) VALUES
(person_id_seq.NEXTVAL, 'John Travolta', TO_DATE('1954-02-18', 'YYYY-MM-DD'));
INSERT INTO actors (id, person_id) VALUES
(actors_id_seq.NEXTVAL, person_id_seq.CURRVAL);
INSERT INTO movies (id, title, release_year, genre_id, director_id) VALUES
